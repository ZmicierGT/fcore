...
class BackTestOperations():
    ...
    def append_calc_data(self, data):
        """
        ...
        """
        num = self.get_calc_data_num()

        self.get_all_calc_data().append(data)

        return num

    def get_calc_data_num(self):
        """
            Get the number of data entries generated by tools.

            Returns:
                int: the number of data entries generated by tools.
        """
        return len(self.get_all_calc_data())

    def get_all_calc_data(self):
        """
            Get all the data used in the calculation.

            Returns:
                The array with the data generated by all data-tools used in the calculation for the symbol in the strategy.
        """
        return self._sym_results.Tech

    def get_calc_data(self, num=0):
        """
            Get the calculated data.

            Args:
                num(int): the index of a data tool to get.
