"""Demo of equal sector weight portfolio simulation.
...
from data.fvalues import Weighted, sector_titles, sectors_dict, sectors_combined

import plotly.graph_objects as go
import sys

# Note that you can specify the date up to 30 Jun 2000 even prior to the date of EQL inception.
first_date = "2009-07-10"  # The first date to fetch quotes
last_date = "2024-07-10"  # The last date to fetch quotes

etf = 'EQL'  # ETF which follows the index for comparison. Use another one if comparing performance before 2009-07-10
...
if __name__ == "__main__":
    ...
    for symbol_idx, sector in sectors_combined.items():
        try:
        ...
        # Override Financial services to the actual sector represented by ETF
        data._info['sector'] = sector
